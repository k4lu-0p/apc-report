                        ...
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="" width="100%">
                          ...
                          <tr>
                            <td align="center" style="font-size:0px;padding:15px 25px 25px 25px;word-break:break-word;">
                              <div style="font-family:Raleway, Lato, Helvetica, Arial, sans-serif;font-size:20px;line-height:1;text-align:center;color:#2d3748;">Pour <strong> {{ $customer_name }}</strong></div>
                            </td>
                          </tr>
                          <tr>
                            <td align="center" style="font-size:0px;padding:10px 10px;word-break:break-word;">
                              <div style="font-family:Raleway, Lato, Helvetica, Arial, sans-serif;font-size:16px;line-height:1;text-align:center;color:#2d3748;">Rappel de votre rendez-vous avec <strong>{{ $user }}</strong> :</div>
                            </td>
                          </tr>
                        </table>
                      </td>
