...
<!-- eslint-disable max-len */ -->
  <form class="w-full" @submit.prevent="onSubmit" enctype="multiplart/form-data">
    ...
    <div class="flex flex-col py-2">
      <label class="py-2 block text-gray-800" for="subject">
        Sujet :
    ...
    <div class="flex flex-col py-2">
      <label class="py-2 block text-gray-800" for="attachment">
        Pièce jointe (.pdf uniquement) :
        <span class="text-red-500">*</span>
      </label>
      <div class="overflow-hidden relative w-64 mb-4">
        <button class="bg-teal-600 text-white font-bold py-2 px-4 w-full inline-flex items-center">
